...
public class NeapolitanConfig {
	public static class Common {
		...
		Common(ForgeConfigSpec.Builder builder) {
			...
			suspiciousBananaPlantChance = builder.comment("The percentage chance for a Suspicious Banana Plant to generate").define("Suspicious Banana Plant chance", 0.125D);
